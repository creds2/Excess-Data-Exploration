...
rm(all_matrix, bounds, correlations, correlations_gas_res, gas_lm1, gas_lm2, gas_lm3, tim)
gc()
all_gas <- all[,rownames(correlations_gas)]
all_gas <- dplyr::sample_n(all_gas, 5000)
gas_lm4 = lm(MeanDomGas_11_kWh ~ (.)^2, data=all_gas, na.action = na.exclude)
summary(gas_lm4)
```

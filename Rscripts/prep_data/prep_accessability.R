...
#town
dir.create("tmp")
unzip("data-input/DFT Acessability/town centres.zip", exdir = "tmp")
access_town <- readxl::read_excel("tmp/town centres.xls", sheet = "ACS0508-2013")
...
names(access_town) <- c("LSOA11",
                        "acc_town_PTtime",
                        "acc_town_PTfrequency",
                        "acc_town_cycletime",
                        "acc_town_cartime",
                        "acc_town_p15min_PT_walk",
                        "acc_town_p15min_cycle",
                        "acc_town_p15min_car",
                        "acc_town_p15min_composite",
                        "acc_town_p30min_PT_walk",
                        "acc_town_p30min_cycle",
                        "acc_town_p30min_car",
                        "acc_town_p30min_composite")



saveRDS(access_town, "data-prepared/access_town.Rds")
